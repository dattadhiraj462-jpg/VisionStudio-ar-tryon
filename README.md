...
.Interactive Catalog: A sleek, dark-themed UI to toggle between different frame styles (Midnight Venice, Arctic Marble, etc.).

.Snapshot Tool: Built-in functionality to capture and download photos of the virtual fitting.
